...
class FollowRequest < ApplicationRecord
  ...
  belongs_to :sender, class_name: "User", foreign_key: "sender_id", counter_cache: :sent_follow_requests_count

  # FollowRequest#recipient: returns a row from the users table associated to this follow request by the recipient_id column
  belongs_to :recipient, class_name: "User", foreign_key: "recipient_id", counter_cache: :received_follow_requests_count
end
